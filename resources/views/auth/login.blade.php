...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('assets/img/logo.jpg') }}" sizes="32x32">
...
<body style="background: url('{{ asset('assets/img/background.jpg') }}') no-repeat center center fixed; background-size: cover;">
